...
@section('content')
    ...
    <div class="px-4 mt-3 md:pl-0">
        <form action="{{ route('admin.user.store.code')}}" method="post" id="form_create_user_code"
            ...
            <div class="grid grid-cols-2 gap-2 md:gap-6 mb-6 md:grid-cols-4 px-4 mt-4">
                <div>
                    ...
                    <input type="text" id="user_code" value="{{ old('user_code')}}" name="user_code"
