...
@section('content')
    <header
        class="transition-all flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full fixed top-0 text-sm py-3 sm:py-0 bg-black  ">
        <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
            aria-label="Global">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand" id="logo">Brand</a>
                <div class="sm:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <a class="font-semibold text-white sm:py-6" href="#" aria-current="page">Landing</a>
                    <a class="text-white sm:py-6" href="#">Account</a>
                    <a class="text-white sm:py-6" href="#">Work</a>
                    <a class="text-white sm:py-6" href="#">Blog</a>

                    <div
                        class="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
                        <button type="button"
                            class="flex items-center w-full text-white hover:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 ">
                            Dropdown
                            <svg class="ms-2 size-2.5 text-white dark:text-neutral-500" width="16" height="16"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button type="button"
                                    ...
                                    Sub Menu
                                    <svg class="sm:-rotate-90 ms-2 size-2.5 text-gray-500 dark:text-neutral-500"
                    ...
                    <a class="flex items-center gap-x-2 font-medium text-white hover:text-blue-600 sm:border-s sm:border-gray-300 sm:my-6 sm:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500"
                        href="#">
